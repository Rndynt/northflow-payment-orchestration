 ...
 *
 * Isolated implementation for the payment-orchestration-service.
 * Does NOT import from legacy payment domains — fully self-contained.
 *
 * ┌──────────────────────────────────────────────────────────────────────────┐
...
export class FakeGatewayProvider implements PaymentProviderAdapter {
